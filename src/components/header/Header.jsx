...
const Header = () => {
  ...
  return (
    <div className="w-full">
      <div
        className="flex bg-white max-[1024px]:flex-col-reverse change-bg headerContainer"
      >
        <div className="flex  items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
          <div>
            <h2 className="text-3xl font-bold text-gray-800 md:text-4xl">
              {En.Iam}{" "}
              <span className="text-gray-500">{En.name}</span>
            </h2>
        ...
        <div
          className="mb-11 lg:block lg:w-1/2 custom-clip-path"
        >
          <div
            className="h-full max-[550px]:h-60 max-[1024px]:h-96 max-[750px]:h-72 object-cover bg-cover custom-bg-header"
          >
